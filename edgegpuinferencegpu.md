# Azure Fillstation AI model built using Azure Cognitive Service Custom vision inference at edge

## Goal to inference the model created in the below fillstation AI

- https://github.com/balakreshnan/csitestbedai/blob/main/fillstationai.md

## Steps

- This repo has the images for the modelling
- Upload the images to Azure Cognitive Custom Vision UI
- Create the Tags Red, Blue, Yellow
- Now create the bounding box atleast each with 25 labels
- Click Train and wait for training to complete
- Click Export and then select ONNX runtime
- This will downlod the zip file to local computer
- Now we can write the onnx inference python code
- Unzip the file to a location
- I am using python to inference at edge
- also using GPU to better performance
- Dependant file
...
if __name__ == "__main__":
 ...
 - Run the python file
 - you should see a video with bounding box
 - i did the test with CSI lab
 - Configured a camera to the laptop where the code was running
 - Recorded the output as well

https://youtu.be/_tKy85pHh-Y

- I also moved the camera and vial to different position to see the accuracy of the model
- Check the accuracy of below video

https://youtube.com/shorts/oEgBovj4ICU?feature=share

- There is lot can be accomplished for research to make the model with accuracy
- HAve fun hacking.
